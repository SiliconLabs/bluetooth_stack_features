...
The readme file of this project can be found [here](https://github.com/SiliconLabs/bluetooth_stack_features/blob/master/security/handling-missing-bonding-keys/README.md). 
.
